...
const OrderCart = ({pizza}) => {
  ...
  return (
    <div className="w-1/2 mt-10">
      ...
      <div className="text-end border-t-2 border-slate-300 pt-5 mt-5">
        <div>
          ...
          &nbsp;
          <span className="text-lg text-[#FE5F1E] font-semibold">₹{pizza.reduce((acc, item) => acc + item.price, 0)}</span>
        </div>
    ...
    focus:outline-none focus:ring-[#FE5F1E] focus:border-[#FE5F1E] w-80"
        ...
        <div>
            <button className="bg-[#FE5F1E] mt-4 mb-10 hover:bg-[#b2330185] text-white px-6 py-2 rounded-2xl text-md">
                Login to continue
            </button>
        </div>
      </div>
